...
const SERVER_PATH: &str = "node_modules/@glint/ember-tsc/bin/glint-language-server.js";
const PACKAGE_NAME: &str = "@glint/ember-tsc";

const TYPESCRIPT_PACKAGE_NAME: &str = "typescript";
const TS_PLUGIN_PACKAGE_NAME: &str = "@glint/tsserver-plugin";
...
impl zed::Extension for EmberExtension {
    ...
    fn language_server_initialization_options(
        ...
        let initialization_options = LspSettings::for_worktree("glint", worktree)
            .ok()
        ...
        match target_language_server_id.as_ref() {
            "typescript-language-server" => Ok(Some(serde_json::json!({
                "plugins": [{
                    ...
                    "languages": ["glimmer (typescript)", "glimmer (javascript)"],
                }],
            }))),
            _ => Ok(None),
        }
